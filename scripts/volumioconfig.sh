...
if [ $(uname -m) = armv7l ] || [ $(uname -m) = aarch64 ]; then
  ...
  if [ $ARCH = arm ]; then
     ...
     wget http://repo.volumio.org/Volumio2/Binaries/arm/volumio-remote-updater_1.4-armhf.deb
     dpkg -i volumio-remote-updater_1.4-armhf.deb
     rm volumio-remote-updater_1.4-armhf.deb
    ...
    wget http://repo.volumio.org/Volumio2/Binaries/arm/volumio-remote-updater_1.4-armv7.deb
    dpkg -i volumio-remote-updater_1.4-armv7.deb
    rm volumio-remote-updater_1.4-armv7.deb
...
wpa_passphrase=volumio2" >> /etc/hostapd/hostapd-edimax.conf
  ...
  wget http://repo.volumio.org/Volumio2/Binaries/x86/volumio-remote-updater_1.4-i386.deb
  dpkg -i volumio-remote-updater_1.4-i386.deb
  rm /volumio-remote-updater_1.4-i386.deb
